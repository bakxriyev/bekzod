  ...
  return (
    <div id="who" className="w-full relative overflow-hidden" style={{ minHeight: "calc(100vh - 1px)" }}>
      ...
      <div className="absolute left-0 top-0 h-full w-72 sm:w-[400px] md:w-[600px] opacity-50 sm:opacity-100">
        <Image src="/lampochka.webp" alt="Background gear" fill className="object-contain object-left" priority />
      </div>
      ...
      <div className="container mx-auto px-4 pt-2 sm:pt-4 relative z-10">
        ...
        <div className="flex flex-col items-center">
          <div className="relative w-56 h-72 sm:w-72 sm:h-96 md:w-[350px] md:h-[450px] mb-6 sm:mb-8">
            <Image src="/kitob.webp" alt="NIMA UCHUN AYNAN MEN?" fill className="object-contain" priority />
          </div>
          ...
          <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 pb-4">
            {features.map((feature, index) => (
              ...
              >
                ...
                <h3 className="text-xs sm:text-sm md:text-base font-bold text-center">{feature.title}</h3>
              </div>
            ))}
          </div>
        </div>
